...
@pytest.fixture
def mock_write_serial_number():
    with patch("home_assistant_bms_tools_integration.config_flow.BMSToolsConfigFlow.write_serial_number"):
        yield
...
async def test_async_step_serial_number(hass, mock_bms_tools, mock_write_serial_number):
